...
//            aliyunMediaPlayer.setDisplay(null);
    ...
    public void prepare() {
        ...
        mMediaHandler.post(() -> {
            ...
            //  配置请求头 refer UA (from JZDataSource.headerMap)
            if (jzvd.jzDataSource != null && jzvd.jzDataSource.headerMap != null
                    && !jzvd.jzDataSource.headerMap.isEmpty()) {
                java.util.ArrayList<String> headerList = new java.util.ArrayList<>();
                for (java.util.Map.Entry<String, String> entry : jzvd.jzDataSource.headerMap.entrySet()) {
                ...
                if (!headerList.isEmpty()) {
                    config.setCustomHeaders(headerList.toArray(new String[0]));
                }
            }
