...
public class AllChannelInPlaylistFragment extends CaseChannelListFragment {
    ...
    public AllChannelInPlaylistFragment() {
    ...
    public static AllChannelInPlaylistFragment newInstance(long playlistId) {
        AllChannelInPlaylistFragment fragment = new AllChannelInPlaylistFragment();
...
//        }
    ...
    public void successResult(List<Channel> data) {
        ...
        AllChannelInPlaylistFragment.this.setBadgeText(THISCLAZZNAME, String.valueOf(data.size()));
