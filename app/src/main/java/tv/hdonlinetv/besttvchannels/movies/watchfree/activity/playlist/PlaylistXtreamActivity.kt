...
class PlaylistXtreamActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener,
    ...
    * /                        .show(); */
    ...
    companion object {
        ...
        fun newInstance(context: Context?, playlist: PlaylistImpl): Intent {
            val intent = Intent(
                context,
                PlaylistXtreamActivity::class.java
            )
