...
public class MainActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.addFab.setOnClickListener(v -> {
            settingsLauncher.launch(new Intent(this, PlaylistManagementActivity.class));
        });
...
//    }
    ...
    private void var0() {
        tabTitles = getResources().getStringArray(R.array.tab_titles_main);
    ...
    private void var0m() {
        ...
        fragmentList = new ArrayList<>();
        fragmentList.add(new XstreamsLiveFragment());
        fragmentList.add(new XtreameVodStreamsFragment());
        fragmentList.add(new XtreameSeriesStreamsFragment());
//        fragmentList.add(new FavoritesFragment());
        tabAdapter = new ViewPagerAdapter(this, getSupportFragmentManager(), fragmentList);
        binding.viewPager.setAdapter(tabAdapter);
    }
