...
public class PlaylistXtreamActivity extends BaseActivity
...
//        }
        ...
        binding.searchView.setOnQueryTextListener(new SimpleSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(@NonNull String query) {
                ...
                Intent intent = new Intent(PlaylistXtreamActivity.this, SearchActivity.class);
...
//                    .addQueryParameter("password", password)
    ...
    private void var0(final long id) {
        XtreamInput tmp = toXtrimInput(playlist);
        tabTitles = getResources().getStringArray(R.array.tab_titles_xtream);
        fragmentList = new ArrayList<>();
        fragmentList.add(XstreamsLiveFragment.newInstance(tmp));
        fragmentList.add(XtreameVodStreamsFragment.newInstance(tmp));
        fragmentList.add(XtreameSeriesStreamsFragment.newInstance(tmp));
