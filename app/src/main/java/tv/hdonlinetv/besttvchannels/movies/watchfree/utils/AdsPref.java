...
import tv.hdonlinetv.besttvchannels.movies.watchfree.Config;
...
public class AdsPref {
    ...
    public static String TEST_NATIVE_ID = "ca-app-pub-3940256099942544/2247696110";
...
//    }
    ...
    public String getAdStatus() {
        return sharedPreferences.getString("ad_status", Config.AD_STATUS);
    }

    public String getAdType() {
        return sharedPreferences.getString("ad_type", Config.AD_TYPE);
    }

//    public String getAdMobPublisherId() {
//        return sharedPreferences.getString("admob_publisher_id", Config.ADMOB_PUB_ID);
//    }
...
//    }
    ...
    public String getAdMobBannerId() {
        ...
        if (BuildConfig.DEBUG) {
            return TEST_BANNER_ADS;
        }
        return mContext.getString(R.string.b1);
    }
